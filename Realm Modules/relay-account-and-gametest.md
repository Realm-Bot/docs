---
label: Relay Account and GameTest
description: Understand the shared Relay Account, GameTest Pack, Beta API, permission, and connection requirements used by Realm Bot modules.
order: 5
authors:
  - name: Frazer
