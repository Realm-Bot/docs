...
description: Control how Realm Bot displays player information in commands, including a compact view or a more detailed output for moderation and auditing.
order: 94
authors:
  - name: Frazer
