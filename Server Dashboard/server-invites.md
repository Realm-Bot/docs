---
label: Invite Links
description: Create secure, shareable invite links (realmbot.link/...) that let players join your Minecraft Bedrock Realms through a controlled, auditable flow with optional VPN/Tor blocking.
order: 90
authors:
  - name: Frazer
