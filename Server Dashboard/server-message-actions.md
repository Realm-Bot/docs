...
description: Configure the automated moderation messages sent to players when actions are taken, using variables to keep messages consistent, informative, and compliant.
order: 96
authors:
  - name: Frazer
