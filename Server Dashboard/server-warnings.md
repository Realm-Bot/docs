---
label: Warn Settings
description: Configure warning types with custom reasons and thresholds, allowing consistent moderation and automatic escalation based on the number of warnings issued.
order: 95
authors:
  - name: Frazer
